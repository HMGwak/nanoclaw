...
function workflowRepository() {
  return createWorkflowRepository(db);
}
...
export function updateWorkflow(
  ...
  workflowRepository().updateWorkflow(id, updates);
}

export function getWorkflowsByStatus(status: WorkflowStatus): WorkflowRun[] {
  return workflowRepository().getWorkflowsByStatus(status);
}
...
export function createWorkflowStep(data: {
  ...
  return workflowRepository().createWorkflowStep(data);
}

export function getWorkflowStep(id: string): WorkflowStepRun | undefined {
  return workflowRepository().getWorkflowStep(id);
}

export function getWorkflowSteps(workflowId: string): WorkflowStepRun[] {
  return workflowRepository().getWorkflowSteps(workflowId);
}
...
export function updateWorkflowStep(
  ...
  workflowRepository().updateWorkflowStep(id, updates);
}

export function getExpiredLeases(): WorkflowStepRun[] {
  return workflowRepository().getExpiredLeases();
}

export function getActiveWorkflowContainerCount(): number {
  return workflowRepository().getActiveWorkflowContainerCount();
}
